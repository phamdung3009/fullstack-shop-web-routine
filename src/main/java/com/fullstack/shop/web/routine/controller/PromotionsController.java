...
public class PromotionsController {
	...
	@GetMapping("/all")
	public ResponseEntity<Page<PromotionsResponseDTO>> getPromotionsList(Pageable pageable) {
		Page<PromotionsResponseDTO> promotionsPage = promotionsService.getPromotions(pageable);
